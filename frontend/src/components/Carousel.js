    ...
    renderedProd = (products)=>{
        return Object.values(products).map((product, i)=>{
                ...
                <div className="card product-card text-center">
                    <img src={`/images/products/${product.image}`} className="card-img" alt="" />
                    <div className="card-body">
                        <div className="product-detail">
                            ...
                            <Rating star={product.avgRating} review={product.numReviews} />
                            </div>
                        </div>
                    </div>
                    <div className="cta-card bg-dark py-4">
                        <Link to={`/cart/${product._id}`} className="cta-link-main"><i className="fas fa-shopping-cart cta-icon"></i>Adicionar Carrinho</Link>
                    </div>
                </div>
                </LinkContainer>
      ...
      const responsive = {
        ...
        return (
          ...
          <div className="row mb-5">
                    ...
                    <Slider containerClass="slider-container" itemClass="slider-item"
